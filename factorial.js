...
function total_fact(n, anteExito) {
	factorial(n, anteExito, function(ex) {
...
function factorialOk() {
	total_fact(5, function(res) {
		document.getElementById("mensaje").innerHTML = "Factorial de 5 es: "
				+ res
	});
}
...
function factorialConError() {
	total_fact(-1, function(res) {
		document.getElementById("mensaje").innerHTML = "Factorial de -1 es: "
				+ res
	});
}
